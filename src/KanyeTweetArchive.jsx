...
export default function KanyeTweetArchive() {
  ...
  return (
    <div className="min-h-screen bg-white text-black p-4 max-w-2xl mx-auto">
      <h1 className="text-2xl font-bold mb-4">Kanye Tweet Archive</h1>
      ...
      <div className="space-y-4">
        {filteredTweets.map((tweet) => (
          <div key={tweet.id} className="border p-4 rounded shadow-sm">
            <div className="text-sm text-gray-600 mb-1">{tweet.date}</div>
            <div className="text-lg mb-2">{tweet.text}</div>
